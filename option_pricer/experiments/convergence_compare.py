...
"""
Convergence comparison script for the Asian option engine.

How to use:
1. Save your original pricing code in a file, for example: asian_option_engine.py
2. Save this file next to it as: convergence_compare.py
3. Run:
       python convergence_compare.py

This script compares convergences of:
...
from engines.asian_option_engine import (
    AsianOptionSpec,
    MarketParams,
    mc_asian_price,
    qmc_asian_price_sobol,
    rqmc_asian_price_sobol,
)
...
def run_convergence_study() -> str:
    ...
    for n_paths in path_grid:
        ...
        qmc_plain_price, qmc_plain_se = qmc_asian_price_sobol(
            market=market,
            option=option,
            n_paths=n_paths,
            use_pca=False,
        ...
        qmc_full_price, qmc_full_se = qmc_asian_price_sobol(
            market=market,
            option=option,
            n_paths=n_paths,
            use_pca=True,
        ...
        qmc_pca8_price, qmc_pca8_se = qmc_asian_price_sobol(
            market=market,
            option=option,
            n_paths=n_paths,
            use_pca=True,
        ...
        rqmc_price, rqmc_se, _ = rqmc_asian_price_sobol(
            market=market,
            option=option,
            n_paths=n_paths,
            n_replications=16,
