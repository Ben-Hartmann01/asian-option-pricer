...
"""
Plot convergence of applied methods (Asian option).
...
def run_convergence_data():
    ...
    for n_paths in path_grid:
        ...
        _, qmc_se = qmc_asian_price_sobol(
            market=market,
            option=option,
            n_paths=n_paths,
            use_pca=False,
        ...
        _, qmc_pca_se = qmc_asian_price_sobol(
            market=market,
            option=option,
            n_paths=n_paths,
            use_pca=True,
        ...
        _, rqmc_se, _ = rqmc_asian_price_sobol(
            market=market,
            option=option,
            n_paths=n_paths,
            n_replications=16,
...
def plot_convergence():
    ...
    plt.title("Convergence: MC vs QMC (Asian Option)")
    plt.legend()
    plt.grid(True)
